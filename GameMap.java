...
public class GameMap extends JPanel implements Runnable {
    ...
    public void update() {
        ...
        for (Zombie zombie : Zombie.zombies) {
            if (zombie.is_slow && time >= zombie.slowTime + 3) {
                zombie.is_slow = false;
